...
import (
	...
	"GoZeroExample/application/like/rpc/internal/config"
	"GoZeroExample/application/like/rpc/internal/server"
	"GoZeroExample/application/like/rpc/internal/svc"
	"GoZeroExample/application/like/rpc/service"
