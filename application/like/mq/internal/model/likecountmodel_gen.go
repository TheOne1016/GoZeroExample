...
type (
	...
	LikeCount struct {
		...
		TargetId   int64     `db:"target_id"`   // 点赞对象id
...
func (m *defaultLikeCountModel) Delete(ctx context.Context, id int64) error {
	...
	beyondLikeLikeCountBizIdObjIdKey := fmt.Sprintf("%s%v:%v", cacheBeyondLikeLikeCountBizIdTargetIdPrefix, data.BizId, data.TargetId)
...
func (m *defaultLikeCountModel) FindOneByBizIdObjId(ctx context.Context, bizId string, objId int64) (*LikeCount, error) {
	beyondLikeLikeCountBizIdObjIdKey := fmt.Sprintf("%s%v:%v", cacheBeyondLikeLikeCountBizIdTargetIdPrefix, bizId, objId)
	var resp LikeCount
