...
import (
	...
	"GoZeroExample/application/article/api/internal/code"
	"GoZeroExample/application/article/api/internal/svc"
	"GoZeroExample/application/article/api/internal/types"
...
func genFileURL(objectKey string) string {
	return fmt.Sprintf("https://my-beyond-article.oss-cn-shanghai.aliyuncs.com/%s", objectKey)
}
